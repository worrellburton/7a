...
export const meta: MetaFunction = () => [
  ...
  { name: "description", content: "Seven Arrows Recovery serves individuals and families across Arizona, including Tucson, Phoenix, Cochise County, and statewide. Located at the base of the Swisshelm Mountains." },
];
