...
export const meta: MetaFunction = () => [
  ...
  { name: "description", content: "Seven Arrows Recovery offers holistic therapies including yoga, meditation, mindfulness, art therapy, music therapy, and nutritional wellness to support whole-person healing." },
];
