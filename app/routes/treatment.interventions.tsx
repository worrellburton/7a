...
export const meta: MetaFunction = () => [
  ...
  { name: "description", content: "Professional intervention services at Seven Arrows Recovery help families guide loved ones toward treatment through a compassionate, structured process with expert support." },
];
