...
export const meta: MetaFunction = () => [
  ...
  { name: "description", content: "Experience traditional healing practices at Seven Arrows Recovery. Sweat lodge ceremonies, connection to the land, and culturally integrated recovery in the Arizona high desert." },
];
