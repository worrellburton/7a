...
export const meta: MetaFunction = () => [
  ...
  { name: "description", content: "Comprehensive alcohol addiction treatment including medically supervised detox, therapy, and aftercare at Seven Arrows Recovery in Arizona. Call (866) 996-4308." },
];
