...
export const meta: MetaFunction = () => [
  ...
  { name: "description", content: "Comprehensive opioid addiction treatment for prescription painkillers, fentanyl, and other opioids at Seven Arrows Recovery in Arizona. Call (866) 996-4308." },
];
