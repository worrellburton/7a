...
export const meta: MetaFunction = () => [
  ...
  { name: "description", content: "Treatment for marijuana dependence addressing psychological reliance, withdrawal symptoms, and underlying emotional issues at Seven Arrows Recovery in Arizona. Call (866) 996-4308." },
];
