...
export const meta: MetaFunction = () => [
  { title: "FAQs" },
  { name: "description", content: "Find answers to frequently asked questions about Seven Arrows Recovery, including insurance, treatment length, what to bring, family involvement, and the admissions process." },
];
