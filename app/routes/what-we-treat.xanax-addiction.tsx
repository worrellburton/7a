...
export const meta: MetaFunction = () => [
  ...
  { name: "description", content: "Safe, medically supervised Xanax and benzodiazepine detox with individualized tapering protocols and therapeutic support at Seven Arrows Recovery in Arizona. Call (866) 996-4308." },
];
