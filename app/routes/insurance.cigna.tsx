    ...
    'script:ld+json': JSON.stringify([
      {
        ...
        mainEntity: [
          {
            '@type': 'Question',
            name: 'Does Cigna cover drug and alcohol rehab?',
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Yes. Cigna covers substance abuse treatment as part of its behavioral health benefits. This includes medically supervised detox, residential treatment, outpatient therapy, and medication-assisted treatment. Seven Arrows Recovery accepts most Cigna plans.',
            },
          },
          {
            '@type': 'Question',
            name: 'How much does rehab cost with Cigna?',
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Your cost depends on your Cigna plan details including your deductible, copay, coinsurance, and out-of-pocket maximum. Many Cigna members pay a fraction of the total treatment cost. Call (866) 996-4308 for a free benefits check.',
            },
          },
          {
            '@type': 'Question',
            name: 'Does Cigna cover residential rehab?',
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Yes. Most Cigna plans cover residential inpatient treatment for substance use disorders when deemed medically necessary. Cigna uses Evernorth Behavioral Health (formerly Cigna Behavioral Health) to manage these benefits.',
            },
          },
          {
            '@type': 'Question',
            name: 'Will Cigna cover rehab in Arizona if I live in another state?',
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'In most cases, yes. Cigna operates a national provider network, and many plans include out-of-area coverage for residential treatment. Our admissions team can verify whether your specific plan covers treatment at our Arizona campus.',
            },
          },
        ],
      },
      {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            position: 3,
            name: 'Cigna',
            item: 'https://sevenarrowsrecovery.com/insurance/cigna',
          },
        ],
      },
    ]),
