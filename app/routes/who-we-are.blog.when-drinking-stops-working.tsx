...
export const meta: MetaFunction = () => [
  { title: 'When Drinking Stops Working: Recognizing the Signs of Addiction | Seven Arrows Recovery' },
  {
    name: 'description',
    content:
      'Learn to recognize the signs of addiction and understand when substance use has crossed from choice to compulsion. A compassionate guide to knowing when it is time to seek help from Seven Arrows Recovery.',
  },
  { name: 'keywords', content: 'signs of addiction, am I an alcoholic, when to get help for substance abuse, warning signs of drug addiction, addiction treatment near me, substance abuse help' },
];
      ...
      <div className="w-full max-w-2xl">
        <svg viewBox="0 0 600 320" className="w-full h-auto" role="img" aria-label="Animated diagram showing how substances hijack the brain's dopamine reward pathway">
          ...
          <path d="M255 190 Q300 160 330 145" fill="none" stroke="#a0522d" strokeWidth="2" strokeDasharray="6 3" opacity="0.5">
            <animate attributeName="stroke-dashoffset" from="100" to="0" dur="2s" fill="freeze" begin={visible ? '0.8s' : 'indefinite'} />
          </path>
          ...
          <path d="M255 190 Q300 140 330 130" fill="none" stroke="#eb4d4b" strokeWidth="3" opacity="0">
            ...
            <animate attributeName="stroke-dashoffset" from="100" to="0" dur="1.5s" fill="freeze" begin={visible ? '1.5s' : 'indefinite'} />
          </path>
