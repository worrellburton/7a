  ...
  },
  {
    'script:ld+json': JSON.stringify({
      ...
      mainEntity: [
        {
          '@type': 'Question',
          name: 'What types of addiction do you treat at your AZ facility?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Seven Arrows Recovery treats alcohol addiction, opioid and heroin dependency, prescription drug abuse (including benzodiazepines like Xanax), methamphetamine addiction, and co-occurring mental health disorders (dual diagnosis). Our clinical team tailors every treatment plan to the substances and underlying conditions involved.',
          },
        },
        {
          '@type': 'Question',
          name: 'Do you accept out-of-state patients?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Absolutely. Many of our clients travel from outside Arizona for treatment. Research consistently shows that seeking treatment away from familiar environments and triggers significantly improves outcomes. Our admissions team assists with travel coordination and can often facilitate admission within 24 to 48 hours.',
          },
        },
        {
          '@type': 'Question',
          name: 'Will my insurance cover residential treatment at Seven Arrows?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'We accept most major insurance plans including Aetna, Blue Cross Blue Shield, Cigna, Humana, UnitedHealthcare, and TRICARE. Our admissions team provides free, confidential insurance verification so you know your coverage before committing. Call (866) 996-4308 to verify your benefits today.',
          },
        },
      ],
    }),
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-5 text-foreground/70 text-lg leading-relaxed" style={{ fontFamily: 'var(--font-body)' }}>
            <p>
              ...
              who travel from{' '}
              <Link to="/locations/phoenix" className="text-primary underline hover:text-primary/80">
                Phoenix
              </Link>
              ,{' '}
              <Link to="/locations/tucson" className="text-primary underline hover:text-primary/80">
                Tucson
              </Link>
              ,{' '}
              <Link to="/locations/scottsdale" className="text-primary underline hover:text-primary/80">
                Scottsdale
              </Link>
              , and{' '}
              <Link to="/locations/mesa" className="text-primary underline hover:text-primary/80">
                Mesa
              </Link>{' '}
            ...
            <p>
              ...
              <Link to="/who-we-are/areas-we-serve" className="text-primary underline hover:text-primary/80">
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-10">
            ...
            <div className="bg-white rounded-2xl p-8 hover:shadow-md transition-shadow duration-300">
              ...
              >
                ...
                use disorders.{' '}
                <Link to="/our-program/evidence-based" className="text-primary underline hover:text-primary/80">
            ...
            <div className="bg-white rounded-2xl p-8 hover:shadow-md transition-shadow duration-300">
              ...
              >
                ...
                <Link to="/our-program/indigenous-approach" className="text-primary underline hover:text-primary/80">
            ...
            <div className="bg-white rounded-2xl p-8 hover:shadow-md transition-shadow duration-300">
              ...
              >
                ...
                therapy cannot.{' '}
                <Link to="/our-program/equine-assisted" className="text-primary underline hover:text-primary/80">
