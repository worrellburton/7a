...
export const meta: MetaFunction = () => [
  ...
  { name: "description", content: "Seven Arrows Recovery specializes in TraumAddiction\u2122, combining EMDR, somatic experiencing, and body-based interventions to treat trauma and addiction together." },
];
