...
export const meta: MetaFunction = () => [
  ...
  { name: "description", content: "Seven Arrows Recovery provides continuing care, alumni support, aftercare planning, and relapse prevention resources to sustain your recovery long after treatment ends." },
];
