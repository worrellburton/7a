...
export const meta: MetaFunction = () => [
  ...
  { name: "description", content: "Specialized heroin addiction treatment with medically supervised detox and evidence-based therapy at Seven Arrows Recovery in Arizona. Call (866) 996-4308." },
];
