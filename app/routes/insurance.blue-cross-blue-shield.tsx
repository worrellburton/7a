    ...
    'script:ld+json': JSON.stringify([
      {
        ...
        mainEntity: [
          {
            '@type': 'Question',
            name: 'Does Blue Cross Blue Shield cover drug and alcohol rehab?',
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Yes. Blue Cross Blue Shield plans provide coverage for substance abuse treatment including detox, residential inpatient rehab, therapy, and medication-assisted treatment. Coverage details vary by state and plan type. Seven Arrows Recovery accepts most BCBS plans.',
            },
          },
          {
            '@type': 'Question',
            name: 'How much does rehab cost with BCBS insurance?',
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Costs vary depending on your BCBS plan type, deductible, copay, and whether you use an in-network facility. Many BCBS members have low out-of-pocket costs for addiction treatment. Call (866) 996-4308 for a free benefits verification.',
            },
          },
          {
            '@type': 'Question',
            name: 'Does BCBS cover out-of-state rehab?',
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Most BCBS plans include the Blue Card Program, which provides coverage at participating facilities nationwide. This means your BCBS plan from any state can typically be used at Seven Arrows Recovery in Arizona.',
            },
          },
          {
            '@type': 'Question',
            name: 'How long will Blue Cross Blue Shield cover rehab?',
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'BCBS typically covers 30 to 90 days of residential addiction treatment based on medical necessity. Our clinical team conducts regular utilization reviews with BCBS to advocate for the full length of stay your recovery requires.',
            },
          },
        ],
      },
      {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            item: 'https://sevenarrowsrecovery.com/insurance/blue-cross-blue-shield',
          },
        ],
      },
    ]),
