...
export const meta: MetaFunction = () => [
  {
    title:
      'Drug Rehab in Scottsdale AZ | Addiction Treatment Scottsdale | Seven Arrows Recovery',
  },
  {
    name: 'description',
    content:
    ...
    'script:ld+json': JSON.stringify([
      {
        ...
        description:
          'Private drug and alcohol rehab serving Scottsdale, AZ with boutique residential addiction treatment.',
      ...
      },
      {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            position: 3,
            name: 'Scottsdale',
            item: 'https://sevenarrowsrecovery.com/locations/scottsdale',
          },
        ],
      },
    ]),
