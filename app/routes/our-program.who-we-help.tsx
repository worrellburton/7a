...
export const meta: MetaFunction = () => [
  ...
  { name: "description", content: "Seven Arrows Recovery helps adults 18 and older, men and women from all backgrounds, seeking recovery from alcohol, opioids, stimulants, and other substance addictions." },
];
