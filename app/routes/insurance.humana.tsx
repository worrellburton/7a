    ...
    'script:ld+json': JSON.stringify([
      {
        ...
        mainEntity: [
          {
            '@type': 'Question',
            name: 'Does Humana cover drug and alcohol rehab?',
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Yes. Humana covers substance abuse treatment as part of its behavioral health benefits. This includes medically supervised detox, residential treatment, outpatient therapy, and medication-assisted treatment. Seven Arrows Recovery accepts most Humana plans.',
            },
          },
          {
            '@type': 'Question',
            name: 'How much does rehab cost with Humana insurance?',
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Your out-of-pocket cost depends on your specific Humana plan, deductible, copay, and coinsurance. Humana members with strong behavioral health benefits often pay a small fraction of total treatment costs. Call (866) 996-4308 for a free benefits check.',
            },
          },
          {
            '@type': 'Question',
            name: 'Does Humana cover residential inpatient rehab?',
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Yes. Most Humana commercial and Medicare Advantage plans cover residential inpatient treatment for substance use disorders when determined to be medically necessary. Our team works with Humana to secure the appropriate level of care authorization.',
            },
          },
          {
            '@type': 'Question',
            name: 'Does Humana Military/TRICARE cover rehab?',
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Humana Military manages the TRICARE East Region. If you have TRICARE through Humana Military, please see our dedicated TRICARE coverage page or call (866) 996-4308 for specific benefits information.',
            },
          },
        ],
      },
      {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            position: 3,
            name: 'Humana',
            item: 'https://sevenarrowsrecovery.com/insurance/humana',
          },
        ],
      },
    ]),
