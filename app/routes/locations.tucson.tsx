...
const services = [
  {
    ...
    description:
      'Safe, medically managed withdrawal in a comfortable environment with around-the-clock nursing care and physician supervision from day one.',
  },
  {
...
export const meta: MetaFunction = () => [
  {
    title:
      'Drug Rehab in Tucson AZ | Addiction Treatment Tucson | Seven Arrows Recovery',
  },
  {
    name: 'description',
    content:
      'Find drug rehab near Tucson, AZ. Seven Arrows Recovery is located just 90 miles from Tucson, offering medical detox, residential treatment, trauma therapy, equine-assisted therapy, and dual diagnosis care. Call (866) 996-4308.',
  },
  {
    'script:ld+json': JSON.stringify([
      {
        ...
        description:
          'Drug and alcohol rehab near Tucson, AZ offering residential addiction treatment, detox, and holistic therapies.',
        telephone: '+18669964308',
        url: 'https://sevenarrowsrecovery.com/locations/tucson',
        areaServed: {
          '@type': 'City',
          name: 'Tucson',
          addressRegion: 'AZ',
      ...
      },
      {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            position: 3,
            name: 'Tucson',
            item: 'https://sevenarrowsrecovery.com/locations/tucson',
          },
        ],
      },
    ]),
