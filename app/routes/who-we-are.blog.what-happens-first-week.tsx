...
export const meta: MetaFunction = () => [
  ...
  { name: 'keywords', content: 'what to expect in rehab, first week of treatment, substance abuse treatment process, detox timeline, what happens in rehab, rehab first day' },
];
...
export default function BlogFirstWeek() {
  return (
    <>
      <PageHero
      ...
      <article className="py-16 lg:py-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Back link */}
          <Link to="/who-we-are/blog/when-drinking-stops-working" className="text-primary text-sm font-semibold hover:underline mb-8 inline-block" style={{ fontFamily: 'var(--font-body)' }}>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 bg-dark-section rounded-2xl p-8 lg:p-12 text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link to="/admissions" className="btn-outline border-white text-white hover:bg-white hover:text-foreground">Start Admissions</Link>
            </div>
          </div>
