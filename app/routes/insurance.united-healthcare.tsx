    ...
    'script:ld+json': JSON.stringify([
      {
        ...
        mainEntity: [
          {
            '@type': 'Question',
            name: 'Does UnitedHealthcare cover drug and alcohol rehab?',
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Yes. UnitedHealthcare covers substance abuse treatment through Optum Behavioral Health, its behavioral health management division. Coverage includes detox, residential treatment, therapy, and medication-assisted treatment. Seven Arrows Recovery accepts most UHC plans.',
            },
          },
          {
            '@type': 'Question',
            name: 'How much does rehab cost with UnitedHealthcare?',
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Costs depend on your UHC plan type, deductible, copay, and coinsurance. Many UnitedHealthcare members have significant coverage for addiction treatment with manageable out-of-pocket costs. Call (866) 996-4308 for a free benefits verification.',
            },
          },
          {
            '@type': 'Question',
            name: 'Does UHC require prior authorization for rehab?',
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Most UnitedHealthcare plans require prior authorization through Optum Behavioral Health before beginning residential treatment. Our admissions team handles the full authorization process, including clinical documentation and utilization review coordination.',
            },
          },
          {
            '@type': 'Question',
            name: 'What UHC plan types does Seven Arrows accept?',
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Seven Arrows Recovery works with most UnitedHealthcare plan types including Choice Plus, Options PPO, Navigate, and employer-sponsored plans. We also accept UHC plans administered through Optum and UMR. Call to verify your specific plan.',
            },
          },
        ],
      },
      {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            item: 'https://sevenarrowsrecovery.com/insurance/united-healthcare',
          },
        ],
      },
    ]),
