...
export const meta: MetaFunction = () => [
  { title: "Contact Us" },
  { name: "description", content: "Get in touch with Seven Arrows Recovery. Call (866) 996-4308 or reach out online. Our admissions team is available 24/7 to help you begin your recovery journey." },
];
