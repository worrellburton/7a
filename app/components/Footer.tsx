    ...
    <footer className="bg-foreground text-white relative overflow-hidden" role="contentinfo">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-xs font-semibold tracking-wider uppercase mb-4">Quick Links</h3>
            <ul className="space-y-2.5" role="list">
              {['Who We Are', 'Treatment', 'Our Program', 'Admissions'].map((item) => (
                <li key={item}>
                  <Link
                    to={`/${item.toLowerCase().replace(/\s+/g, '-')}`}
                    className="text-white/50 text-xs hover:text-primary transition-colors"
                  >
                    {item}
                  </Link>
                </li>
          ...
          {/* What We Treat */}
          <div>
            <h3 className="text-xs font-semibold tracking-wider uppercase mb-4">What We Treat</h3>
            <ul className="space-y-2.5" role="list">
            ...
            <h3 className="text-xs font-semibold tracking-wider uppercase mb-4 mt-6">Areas We Serve</h3>
            <ul className="space-y-2.5" role="list">
              {[
                ...
                <li key={loc.name}>
                  <Link to={loc.href} className="text-white/50 text-xs hover:text-primary transition-colors">
                    {loc.name}, AZ
                  </Link>
                </li>
              ))}
          ...
          {/* Contact */}
          <div>
            <h3 className="text-xs font-semibold tracking-wider uppercase mb-4">Contact Us</h3>
            <div className="space-y-2.5 text-xs text-white/50">
              <a href="tel:+18669964308" className="block hover:text-primary transition-colors text-sm font-semibold text-white/70">
                (866) 996-4308
              </a>
