            ...
            <div>
              ...
              <ul className="space-y-2.5" role="list">
                {['Who We Are', 'Treatment', 'Our Program', 'Admissions'].map((item) => (
                  <li key={item}>
                    <Link to={`/${item.toLowerCase().replace(/\s+/g, '-')}`} className="text-white/40 text-xs hover:text-primary transition-colors">
                      {item}
                    </Link>
                  </li>
                ))}
            ...
            <div>
              ...
              <ul className="space-y-2.5" role="list">
                {['Alcohol Addiction', 'Opioid Addiction', 'Dual-Diagnosis', 'Heroin Addiction'].map((item) => (
                  <li key={item}>
                    <Link to={`/what-we-treat/${item.toLowerCase().replace(/\s+/g, '-')}`} className="text-white/40 text-xs hover:text-primary transition-colors">
                      {item}
                    </Link>
                  </li>
                ))}
              ...
              <ul className="space-y-2.5" role="list">
                {[
                  ...
                  <li key={loc.name}>
                    <Link to={loc.href} className="text-white/40 text-xs hover:text-primary transition-colors">{loc.name}, AZ</Link>
                  </li>
                ))}
              </ul>
            </div>
