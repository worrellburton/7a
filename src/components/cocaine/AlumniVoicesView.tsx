...
// Cocaine page — alumni voices tiles. Presentation-only client
// component; the server parent injects verified Google review text
// as props.
...
export default function AlumniVoicesView({ quotes }: { quotes: AlumniVoice[] }) {
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            In their <em className="not-italic text-primary">own words</em>.
          </h2>
        </div>
