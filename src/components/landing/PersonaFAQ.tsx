    ...
    items: [
      {
        ...
        a: 'We maintain small-census residential on purpose (low client-to-staff ratio, credentialed clinical team, every name known). Availability varies by week. Call admissions directly — we\'ll give you an accurate intake window rather than a sales answer.',
      },
      {
