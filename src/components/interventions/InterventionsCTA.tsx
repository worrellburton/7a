...
/**
 * Interventions — Phase 10. Final CTA.
 *
 * Dark section with a slow animated aurora gradient behind the copy
 * and a breathing accent dot on the phone button. Trust line below
 * the CTAs.
 */
export default function InterventionsCTA() {
  ...
  return (
    ...
    >
      {/* Slow aurora — two large radial blobs drifting behind the text. */}
      <div
        aria-hidden="true"
        ...
        style={{
          ...
          animation: visible ? 'aurora-shift 18s ease-in-out infinite alternate' : 'none',
        }}
      />
      <style>{`
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          When it&rsquo;s time, it&rsquo;s time
        </p>
        <h2
          id="cta-heading"
        ...
        >
          ...
          <em className="not-italic text-accent">We start today.</em>
        </h2>
        <p
        ...
        >
          Our intervention team takes calls 24/7, holds emergency
          deploys within 24 hours when the situation requires it, and
          works with families nationwide. The first conversation is
          confidential, free, and has no obligation attached.
        </p>
        <div
