...
import { admissionsFaqs } from './admissionsFaqs';
...
export default function AdmissionsFAQ() {
  ...
  return (
    <section
      ...
      aria-labelledby="admissions-faq-heading"
    >
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="section-label mb-5">Admissions FAQ</p>
          <h2
          ...
          >
            The <em className="not-italic text-primary">real</em> questions.
          </h2>
          <p
