...
/**
 * Admissions — Phase 10. Closing CTA.
 *
 * Warm-gradient sign-off mirroring the rest of the 10-phase closers.
 * Echoes the hero thesis ("A place to land") and offers the two
 * canonical conversion paths: call and insurance verification.
 */
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32 text-center">
        ...
        >
          The door is <em className="not-italic" style={{ color: 'var(--color-accent)' }}>open</em>. The light is on.
        </h2>
        <p
        ...
        >
          One call. Free insurance check. No sales pitch, no commitment, no
          trick close. Just a conversation about whether Seven Arrows is
