...
const steps: Step[] = [
  {
    ...
    duration: 'Minutes',
    body:
      'Dial (866) 718-1665 or submit the insurance form. Our admissions coordinator listens first, then asks a few questions to understand who you are calling for, what substance or substances, and what the urgency looks like. No script, no sales pitch.',
  },
  {
