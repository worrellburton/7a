...
/**
 * Careers — Phase 1 hero.
 *
 * Keyword-rich H1 + lede speaks to the candidate — clinician,
 * counselor, nurse, BHT — and names the setting. Video backdrop
 * matches the inner-page chrome.
 */
    ...
    >
      ...
      >
        <div className="min-h-[74vh] lg:min-h-[82vh] pb-24 lg:pb-32 flex flex-col justify-end">
          ...
          >
            Do the work you <em className="not-italic" style={{ color: 'var(--color-accent)' }}>came to do</em>.
          </h1>
          ...
          >
            Seven Arrows Recovery is hiring clinicians, counselors, nurses,
            behavioral-health techs, and holistic practitioners for our 160-acre
            residential ranch in Cochise County, Arizona. Small caseloads,
            trauma-informed care, and a team that takes the work seriously
