...
const personas: Persona[] = [
  ...
  },
  {
    ...
    body:
      'Trauma-informed care for clients whose exposure to critical incidents, moral injury, or combat has driven substance use. Our Forward-Facing® Accelerated Recovery approach is built for this population.',
    glyph: (
      <svg viewBox="0 0 32 32" className="w-7 h-7" aria-hidden="true" {...s}>
