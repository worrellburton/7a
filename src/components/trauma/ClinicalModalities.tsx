    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mb-14 lg:mb-20" style={style(0.05)}>
          ...
          >
            How we deliver Forward-Facing<span className="align-super text-[0.55em]">®</span> Accelerated Recovery care.
          </h2>
          <p
          ...
          >
            ...
            the Forward-Facing&reg; Accelerated Recovery framework and trauma-
        ...
        <div className="grid gap-4 lg:gap-5 lg:grid-cols-12 lg:auto-rows-[minmax(180px,auto)]">
          ...
          >
            ...
            <div className="relative max-w-3xl">
              ...
              >
                Forward-Facing<span className="align-super text-[0.55em]">®</span> Accelerated Recovery Treatment
              </h3>
