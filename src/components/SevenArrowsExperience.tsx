    ...
    <section className="py-20 lg:py-28 bg-white" aria-labelledby="experience-heading">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <p
            className="text-foreground/60 leading-relaxed mx-auto"
          ...
          >
            ...
            experience of mind, body and spirit — grounded in a boutique treatment setting
            built to feel like a home away from home.
          </p>
        </div>
