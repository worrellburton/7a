...
/**
 * Alumni & Aftercare — Phase 1 hero.
 *
 * Recovery doesn't end at the gate. Video backdrop matches the
 * rest of the inner-page chrome; lede carries SEO/GEO-relevant
 * keywords (aftercare planning, alumni program, relapse prevention,
 * sober living, IOP/PHP step-down).
 */
export default function AlumniHero() {
  ...
  return (
    <section
      ...
      aria-labelledby="alumni-hero-heading"
        ...
        <div className="min-h-[80vh] lg:min-h-[86vh] pb-24 lg:pb-32 flex flex-col justify-end">
          ...
          >
            <ol className="flex items-center gap-2 flex-wrap">
              ...
              <li className="text-white/40">/</li>
              <li className="text-white/80">Alumni &amp; Aftercare</li>
            </ol>
          </nav>
          ...
          >
            Recovery doesn&rsquo;t end at <em className="not-italic" style={{ color: 'var(--color-accent)' }}>the gate</em>.
          </h1>
          ...
          >
            Seven Arrows&rsquo; continuing-care program is built around the
            hardest months &mdash; the first 90 days after discharge. Individual
            aftercare plans, IOP and PHP step-down, sober-living placement,
            alumni groups, and 24/7 crisis support so you never do the next
            stretch alone.
          </p>
