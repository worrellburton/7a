...
const stats = [
  ...
  { value: 20, suffix: '<', unit: 'small census', label: 'every client known by name, never a number' },
  { value: 12, suffix: '+', unit: 'horses', label: 'on the ranch, partnered with our equine therapy program' },
