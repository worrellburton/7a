...
/**
 * Family Program — Phase 10 closing CTA. Warm-gradient sign-off.
 * Speaks directly to the family member on the page — whether their
 * loved one is already in treatment or they're researching for
 * someone who isn't in yet.
 */
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32 text-center">
        ...
        >
          If you&rsquo;re the one making the call
        </p>
        <h2
        ...
        >
          You do not have to <em className="not-italic" style={{ color: 'var(--color-accent)' }}>figure this out alone</em>.
        </h2>
        <p
        ...
        >
          Admissions will listen to the situation, tell you honestly what
          your options are, and help you figure out the next conversation to
          have &mdash; with your loved one, or with yourself.
        </p>
        <div
