...
export const familyFaqs: FamilyFaq[] = [
  ...
  },
  {
    ...
    a: 'Yes. Our open-enrollment family education groups run virtually on a multi-week cadence and are open to anyone with a loved one in recovery — current client or not. Ask admissions for the next start date.',
  },
  {
    q: 'What happens to family support after my loved one discharges?',
    a: 'The family program continues. We include referrals to family-focused outpatient providers in your area, a family track in our alumni community, quarterly alumni family events on the ranch, and guidance on the first 90 days at home.',
  },
  {
