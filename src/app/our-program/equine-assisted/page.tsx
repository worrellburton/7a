...
export const metadata: Metadata = {
  ...
  description:
    'Discover equine-assisted therapy at Seven Arrows Recovery. Horse therapy promotes emotional regulation, trust building, and outdoor healing in the Arizona high desert.',
};
