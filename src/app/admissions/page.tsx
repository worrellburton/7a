...
export const metadata: Metadata = {
  title: 'Admissions',
  description:
    'Begin your recovery journey at Seven Arrows Recovery. Learn about our simple admissions process, verify your insurance, and start treatment within 24-48 hours.',
};
