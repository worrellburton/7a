...
// ------------------------------------------------------------
// Accounts Receivables panel — renders every Income-classified
// account from QuickBooks for the given realm. Rendered inside
// the Finance page as a section tab (alongside Budget / BvA /
// Reports); it doesn't own its own QBO connection state.
// ------------------------------------------------------------
...
export default function AccountsReceivablesPanel({ realmId }: Props) {
  ...
  // Income / Other Income as a fallback for any charts of accounts
  // where Classification isn't populated.
