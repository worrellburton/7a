...
const METRICS: MetricDef[] = [
  ...
  // paid ads, direct, referral, social, email).
  {
    ...
    scope: 'organic',
    label: 'Sessions',
    description: 'Visits from an unpaid search result — Google, Bing, DuckDuckGo, etc. — plus AI-search engines (ChatGPT, Perplexity, Claude, Gemini, Copilot). Excludes paid ads, direct, social, email, referral.',
  ...
  },
  {
    ...
    scope: 'organic',
    label: 'Users',
    description: 'Distinct people whose day on the site started from an organic or AI-search click (one user can have multiple such sessions).',
  ...
  },
  {
    ...
    scope: 'organic',
    label: 'New users',
    description: 'First-time visitors who found the site via an organic search or AI-search engine. The clearest signal of SEO + GEO acquisition working.',
  ...
  },
  {
    ...
    scope: 'organic',
    label: 'Page views',
    description: 'Total page loads from organic + AI-search sessions. High per-session ratios suggest the landing copy is doing its job.',
  ...
  },
  {
    ...
    description: '% of organic + AI-search sessions that were "engaged" (≥10s, ≥1 conversion, or ≥2 page views). GA4’s replacement for the old bounce-rate metric.',
