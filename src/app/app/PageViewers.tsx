...
export default function PageViewers() {
  ...
  return (
    <div className="fixed bottom-20 left-1/2 lg:left-[calc(50%+8rem)] -translate-x-1/2 z-40 flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/90 backdrop-blur border border-gray-100 shadow-sm">
      <span
