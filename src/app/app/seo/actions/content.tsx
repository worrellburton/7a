...
export default function ActionsContent() {
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto" style={{ fontFamily: 'var(--font-body)' }}>
      ...
      {/* Directory edits feed — single source on this page now.
          Shows status changes, link adds, NAP edits, comments, etc.
          for every directory in real time. The submit form + actions
          table that used to live here were removed; the live feed
          is the entire purpose of the Activities tab. */}
