...
export const metadata: Metadata = {
  ...
  description:
    'Equine-Assisted Psychotherapy at Seven Arrows Recovery integrates relational, somatic, and attachment-focused approaches for powerful trauma-informed healing in the Arizona high desert.',
};
