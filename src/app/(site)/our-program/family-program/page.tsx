...
export const metadata: Metadata = {
  ...
  description:
    'Seven Arrows Recovery\u2019s family program offers therapy, education, and weekly sessions to help families heal together and build a strong foundation for lasting recovery.',
};
