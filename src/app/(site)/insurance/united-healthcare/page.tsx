...
export const metadata: Metadata = {
  ...
  description:
    'Seven Arrows Recovery accepts UnitedHealthcare for addiction treatment in Arizona — detox, residential care, and therapy coverage. Call (866) 718-1665.',
};
...
const steps = [
  {
    ...
    description:
      'Reach our admissions team at (866) 718-1665 with your UnitedHealthcare member ID and group number. We are available around the clock.',
  },
  {
    number: '02',
          ...
          <div className="space-y-6">
            {[
              ...
              },
              {
                ...
                a: 'Costs depend on your UHC plan type, deductible, copay, and coinsurance. Many UnitedHealthcare members have significant coverage for addiction treatment with manageable out-of-pocket costs. Call (866) 718-1665 for a free benefits verification.',
              },
              {
