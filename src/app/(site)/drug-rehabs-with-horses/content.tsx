...
const BENEFITS: Benefit[] = [
  {
    title: 'Emotional Reflection and Awareness',
    body: 'Horses are uniquely attuned to human emotions and can offer immediate, unbiased feedback about the emotional state of those interacting with them. This ability to mirror human emotions creates an invaluable opportunity for individuals to examine their emotional responses and triggers.',
  },
  {
    title: 'Building Trust and Relationship Skills',
    body: 'Developing a relationship with a horse requires patience, consistency, and empathy — essential in rebuilding trust with oneself and others. In drug rehab programs with horses, clients learn how to foster meaningful relationships, a skill that directly translates to rebuilding personal and family connections damaged by addiction.',
  },
  {
    title: 'Enhancing Self-Esteem and Self-Efficacy',
    body: 'Working with horses gives individuals tangible opportunities to experience success, which helps rebuild self-esteem and self-worth. Every accomplishment — leading a horse or completing a grooming task — reinforces the belief that positive change is possible. This process fosters a sense of self-efficacy, which is vital for those committed to a sober life and a future free from addiction.',
  },
  {
    title: 'Fostering Mindfulness and Presence',
    body: 'Interacting with horses requires mindfulness — being fully present in the moment. Horses are sensitive to their environment and the emotional state of those around them. This attentiveness helps individuals become more aware of their thoughts, emotions, and physical sensations. Mindfulness is a powerful tool for managing cravings and emotional triggers, supporting overall emotional regulation and well-being during recovery.',
  },
  {
    title: 'Processing Trauma in a Safe Space',
    body: 'For many individuals struggling with addiction, unresolved trauma is a key contributing factor. Drug rehabs with horses offer a unique opportunity to address trauma in a safe, non-threatening environment. Horses create a calming atmosphere that allows clients to confront and process painful memories or emotions associated with their trauma. Equine drug rehabs offer a space for healing, enabling individuals to release trauma-related emotions and begin the process of emotional recovery.',
  },
];
  ...
  return (
    <>
      <PageHero
        ...
        description="What equine drug rehabs actually do — how working with horses creates emotional reflection, trust, and the kind of presence that traditional talk therapy sometimes cannot reach."
