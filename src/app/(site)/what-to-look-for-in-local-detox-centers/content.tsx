...
export default function PageContent() {
  return (
    <>
          ...
          <div style={{ fontFamily: 'var(--font-body)' }}>
            ...
            <div className="mt-12 pt-8 border-t border-gray-100">
              <p className="text-sm text-foreground/50 mb-4">
                <strong className="text-foreground/70">This is Episode 49 of &ldquo;The Recovery Roadmap&rdquo;</strong> &mdash; an investigative series from Seven Arrows Recovery guiding you from recognition to lasting recovery.
              </p>
              <Link
      ...
      <RelatedArticles slug="what-to-look-for-in-local-detox-centers" />
    </>
  );
}
