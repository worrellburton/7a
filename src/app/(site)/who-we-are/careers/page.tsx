...
export const metadata: Metadata = {
  title: 'Careers',
  description:
    'Join the team at Seven Arrows Recovery. We are hiring compassionate clinicians, therapists, and support staff dedicated to making a difference in addiction treatment.',
};
