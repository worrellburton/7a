      ...
      <article className="py-16 lg:py-24 bg-white">
        <div className="max-w-[1000px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div style={{ fontFamily: 'var(--font-body)' }}>
            ...
            <p className="text-foreground/80 leading-relaxed mb-4">
              At Seven Arrows Recovery, our Forward-Facing&reg; Accelerated Recovery approach recognizes that addiction almost always has deeper roots: unresolved trauma, untreated mental health conditions, chronic stress, or a combination of all three. We do not just treat the symptoms of substance use — we help our clients understand and heal the underlying pain that drove them to use in the first place.
            </p>
            <p className="text-foreground/80 leading-relaxed mb-10">
