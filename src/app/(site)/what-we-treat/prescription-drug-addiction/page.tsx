...
export const metadata: Metadata = {
  ...
  description:
    'Specialized treatment for addiction to benzodiazepines, stimulants, pain medications, and other prescription substances at Seven Arrows Recovery in Arizona. Call (866) 996-4308.',
};
