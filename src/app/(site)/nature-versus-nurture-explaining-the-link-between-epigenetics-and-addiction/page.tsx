...
export const metadata: Metadata = {
  ...
  keywords:
    'nature versus nurture: explaining the link between epigenetics and addiction, nature versus nurture explaining the link between epigenetics and addiction, addiction recovery, Seven Arrows Recovery, Arizona rehab',
  alternates: {
