...
const episode = EPISODES.find((e) => e.slug === 'salutogenic-not-pathological')!;
...
export default function PageContent() {
  return (
    <>
            ...
            <div className="flex flex-col lg:flex-row gap-8 items-start lg:items-center justify-between">
              <div className="max-w-xl">
                <p
                  ...
                  style={{ fontFamily: 'var(--font-body)' }}
                >
                  Looking for the salutogenic frame?
                </p>
                ...
                <p
                  ...
                  style={{ fontFamily: 'var(--font-body)' }}
                >
                  Call any time. The first conversation is confidential,
                  free, and no-obligation. We&apos;ll talk about what&apos;s
                  underneath the symptom that&apos;s still intact, what
                  you&apos;re trying to get back to, and whether what we
                  do is the right next step — including the cases when
                  it isn&apos;t.
                </p>
              </div>
      ...
      <RelatedArticles slug="salutogenic-not-pathological" />
    </>
  );
}
