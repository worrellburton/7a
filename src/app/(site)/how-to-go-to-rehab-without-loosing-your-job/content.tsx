    ...
    <>
      <PageHero
        ...
        breadcrumbs={[
          ...
          { label: 'How to Go to Rehab Without Losing Your Job' },
        ]}
        description="How the Family and Medical Leave Act (FMLA) protects your job while you go to rehab — eligibility, how the leave works for substance abuse treatment, and what to do next."
        ...
        <div className="max-w-[900px] mx-auto px-4 sm:px-6 lg:px-8">
          <div style={{ fontFamily: 'var(--font-body)' }}>
            ...
            <div className="bg-warm-bg rounded-2xl p-8 lg:p-10 text-center">
              ...
              >
                Take the Next Step at Seven Arrows Recovery
              </h3>
              <p className="text-foreground/70 leading-relaxed mb-8 max-w-xl mx-auto">
                If FMLA-protected leave is the door you need to walk through, our admissions team can help you coordinate the timing, paperwork, and conversations with your employer so the whole process feels manageable. Reach out and we&rsquo;ll walk it through with you, step by step.
              </p>
