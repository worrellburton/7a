...
// Public renderer for DB-backed blog posts, served at ROOT level (the
// site's article convention). Static folders under
// /(site)/<slug>/ take precedence (Next.js routes static
