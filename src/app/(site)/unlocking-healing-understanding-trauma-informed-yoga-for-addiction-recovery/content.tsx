...
export default function PageContent() {
  return (
    <>
        ...
        <div className="max-w-[900px] mx-auto px-4 sm:px-6 lg:px-8">
          <div style={{ fontFamily: 'var(--font-body)' }}>
            ...
            <ul className="list-disc pl-6 space-y-2 mb-8 text-foreground/80 leading-relaxed">
              <li>{"Mindful Movement: Gentle yoga poses and sequences promote body awareness and mindfulness, allowing individuals to connect with their physical sensations without judgment. While yoga can be strenuous depending on the style, mindful yoga, known as “yin” yoga, can be extremely beneficial to the nervous system."}</li>
              <li>{"Breathwork: Conscious breathing techniques help regulate the nervous system, reduce anxiety, and promote relaxation. Deep, rhythmic breathing facilitates emotional regulation and enhances self-soothing capacities."}</li>
              <li>{"Guided Meditation: Meditation practices foster inner calm and mental clarity, allowing individuals to observe their thoughts and emotions with detachment. Mindfulness meditation cultivates present-moment awareness, reducing rumination and promoting acceptance of one’s experiences."}</li>
              <li>{"Yoga Nidra: Also known as “yogic sleep,” Yoga Nidra is a guided relaxation practice that induces a state of deep relaxation and heightened awareness. This profound relaxation technique promotes restorative sleep, reduces hyperarousal, and supports emotional healing."}</li>
            </ul>
            <h2 className="text-2xl lg:text-3xl font-bold text-foreground mb-4 mt-12" style={{ fontFamily: 'var(--font-display)' }}>
      ...
      <RelatedArticles slug="unlocking-healing-understanding-trauma-informed-yoga-for-addiction-recovery" />
    </>
  );
}
