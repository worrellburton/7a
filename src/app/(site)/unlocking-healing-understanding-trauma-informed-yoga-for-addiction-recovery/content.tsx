...
export default function PageContent() {
  return (
    <>
      <PageHero
        label={'The Recovery Roadmap — Episode 20'}
        ...
        description={'In the journey toward addiction recovery, healing takes many forms. While traditional therapies and support groups play vital roles, complementary practices such as yoga are gaining recognition…'}
      ...
      <article className="py-16 lg:py-24 bg-white">
        <div className="max-w-[900px] mx-auto px-4 sm:px-6 lg:px-8">
          <div style={{ fontFamily: 'var(--font-body)' }}>
            ...
            <p className="text-foreground/80 leading-relaxed mb-4">
              In addition, yoga promotes neuroplasticity&mdash;the brain&rsquo;s ability to reorganize and form new neural connections. This neurobiological process is crucial in rewiring maladaptive patterns associated with addiction and trauma. Through regular practice, individuals can strengthen neural circuits related to emotion regulation, impulse control, and self-awareness, facilitating long-lasting recovery.
            </p>
            <h2 className="text-2xl lg:text-3xl font-bold text-foreground mb-4 mt-10" style={{ fontFamily: 'var(--font-display)' }}>
            ...
            <p className="text-foreground/80 leading-relaxed mb-4">
              Mindful Movement: Gentle yoga poses and sequences promote body awareness and mindfulness, allowing individuals to connect with their physical sensations without judgment. While yoga can be strenuous depending on the style, mindful yoga, known as &ldquo;yin&rdquo; yoga, can be extremely beneficial to the nervous system.
            </p>
            <p className="text-foreground/80 leading-relaxed mb-4">
            ...
            <p className="text-foreground/80 leading-relaxed mb-4">
              Guided Meditation: Meditation practices foster inner calm and mental clarity, allowing individuals to observe their thoughts and emotions with detachment. Mindfulness meditation cultivates present-moment awareness, reducing rumination and promoting acceptance of one&rsquo;s experiences.
            </p>
            <p className="text-foreground/80 leading-relaxed mb-4">
              Yoga Nidra: Also known as &ldquo;yogic sleep,&rdquo; Yoga Nidra is a guided relaxation practice that induces a state of deep relaxation and heightened awareness. This profound relaxation technique promotes restorative sleep, reduces hyperarousal, and supports emotional healing.
            </p>
            <h2 className="text-2xl lg:text-3xl font-bold text-foreground mb-4 mt-10" style={{ fontFamily: 'var(--font-display)' }}>
            ...
            <div className="mt-12 pt-8 border-t border-gray-100">
              <p className="text-sm text-foreground/50 mb-4">
                <strong className="text-foreground/70">This is Episode 20 of &ldquo;The Recovery Roadmap&rdquo;</strong> &mdash; an investigative series from Seven Arrows Recovery guiding you from recognition to lasting recovery.
              </p>
              <Link
