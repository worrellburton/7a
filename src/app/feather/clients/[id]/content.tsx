  ...
  if (!client) {
    return (
      <div className="p-10">
        ...
        <Link href="/feather/clients" className="mt-4 inline-flex items-center gap-2 text-primary text-sm font-semibold">← Back to clients</Link>
      </div>
    );
  }
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-10 max-w-5xl mx-auto">
      ...
      <div className="flex items-center justify-between gap-3 mb-4">
        <button onClick={() => router.push('/feather/clients')} className="flex items-center gap-2 px-3 py-1.5 bg-warm-bg text-foreground/70 rounded-xl text-sm font-semibold hover:bg-gray-200 transition-colors" style={{ fontFamily: 'var(--font-body)' }}>
      ...
      {tab === 'notes' && (
        <section className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 sm:p-6">
          ...
          <Link href="/feather/notes" className="inline-flex items-center gap-2 px-4 py-2 bg-primary text-white rounded-xl text-sm font-semibold hover:bg-primary/90 transition-colors" style={{ fontFamily: 'var(--font-body)' }}>
            Open Notes
