  ...
  return (
    ...
    >
      ...
      <div className="w-full flex justify-center px-4">
        ...
        />
        {/* Centre Feather mark — small glass pill, kept understated
            so the orbiting team avatars stay the focus. */}
        <div
          aria-hidden="true"
        ...
        >
          <svg
            ...
            aria-hidden="true"
          >
            <path d="M5.5 18.5c0-7 5-13 13-15-1 7-3 11-6 13.5-2.4 2-5.2 2.4-7 1.5z" fill="currentColor" fillOpacity="0.16" />
            ...
            {horses.map((h, i) => {
              ...
              return (
                <div key={h.id} className="orbit-slot" style={slotStyle}>
                  <button
                    type="button"
                    onClick={() => router.push(`/feather/equine/${h.id}`)}
