...
const PRIMARY_TABS: Tab[] = [
  ...
  { href: '/feather/seo/directories', label: 'Backlinks', hint: 'Directory tracker + outreach channels' },
...
function isTabActive(pathname: string, href: string): boolean {
  ...
  if (href === '/feather/seo/directories') {
    const linksRoutes = [
      '/feather/seo/directories',
      '/feather/seo/press-releases',
      '/feather/seo/guest-posts',
      '/feather/seo/brand-profiles',
      '/feather/seo/comments',
      '/feather/seo/forums',
    ];
