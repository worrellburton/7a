...
// to the existing batch runners on /feather/images and /feather/video, which
// kick off the Claude pass via ?autoRun=1.
//
// Reads site_images + site_videos directly via the browser supabase
// client — same RLS path the dedicated /feather/images and /feather/video
