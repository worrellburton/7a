...
function SourceCommandCenter() {
  ...
  const cards: { href: string; label: string; tableKey: string; emoji: string }[] = [
    { href: '/feather/seo', label: 'Keyword ranks', tableKey: 'seo_keyword_ranks', emoji: '◷' },
    { href: '/feather/seo/local', label: 'Local pack', tableKey: 'seo_local_ranks', emoji: '◉' },
    { href: '/feather/seo/questions', label: 'PAA questions', tableKey: 'seo_paa_questions', emoji: '?' },
    { href: '/feather/seo/competitors', label: 'Competitors', tableKey: 'seo_competitor_serps', emoji: '⌘' },
  ];
