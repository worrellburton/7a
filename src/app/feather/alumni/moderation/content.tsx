  ...
  if (!isAdmin) {
    return (
      <div className="px-4 py-10 max-w-md mx-auto text-center" style={{ fontFamily: 'var(--font-body)' }}>
        ...
        <p className="text-[13px] text-foreground/60">Moderation is staff-only. <Link href="/feather/alumni" className="text-primary font-semibold">Back to the alumni hub</Link>.</p>
      </div>
    );
  }
