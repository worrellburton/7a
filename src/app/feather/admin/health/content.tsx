                ...
                {data.stuck_campaigns.map((c) => (
                  <li key={c.id} className="flex items-center justify-between gap-3 px-4 py-2.5">
                    <div className="min-w-0">
                      <Link href={`/feather/email-campaigns/${c.id}/finalize`} className="text-[13px] font-semibold text-foreground truncate hover:underline">
            ...
            <Card title="Scheduled · next up" subtitle="Upcoming auto-fire campaigns ordered by send time.">
              <ul className="divide-y divide-black/5">
                {data.scheduled_campaigns.map((c) => (
                  <li key={c.id} className="flex items-center justify-between gap-3 px-4 py-2.5">
                    <div className="min-w-0">
                      <Link href={`/feather/email-campaigns/${c.id}/finalize?preview=1`} className="text-[13px] font-semibold text-foreground truncate hover:underline">
                        {c.generated_subject || c.id}
                      </Link>
                      <p className="text-[11.5px] text-foreground/55">
