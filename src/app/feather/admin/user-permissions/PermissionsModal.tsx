          ...
          <div>
            ...
            <p className="text-xs text-foreground/50 mt-1">
              {tab === 'pages'
                ...
                : <>Tick extra departments to grant the user access as if they were a member of those departments. Their <span className="font-medium">primary</span> department comes from /feather/team and is shown read-only.</>}
