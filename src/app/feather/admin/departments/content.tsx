...
export default function DepartmentsContent() {
  ...
  async function createDepartment() {
    ...
    if (user) logActivity({ userId: user.id, type: 'org.department_created', targetKind: 'department', targetId: (result as Department).id, targetLabel: name, targetPath: '/feather/departments' });
    setNewName('');
    setNewDescription('');
  ...
  async function deleteDepartment(id: string, name: string) {
    ...
    if (user) logActivity({ userId: user.id, type: 'org.department_deleted', targetKind: 'department', targetId: id, targetLabel: name, targetPath: '/feather/departments' });
  ...
  async function saveEdit(id: string) {
    ...
    if (user) logActivity({ userId: user.id, type: 'org.department_renamed', targetKind: 'department', targetId: id, targetLabel: trimmed, targetPath: '/feather/departments' });
    setEditingId(null);
  }
