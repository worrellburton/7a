...
export default function PagesContent() {
  ...
  if (!user || !isAdmin) {
    if (typeof window !== 'undefined') router.replace('/feather');
    return null;
  }
  ...
  function renderRow(page: PageConfig, indented = false) {
    const locked = page.path === '/feather/team' || page.path === '/feather/admin/pages';
  ...
  return (
    ...
    <div className="p-4 sm:p-6 lg:p-10 max-w-[1060px] mx-auto">
      <div className="mb-8 flex items-start justify-between gap-4 flex-wrap">
        ...
        <button
          onClick={() => router.push('/feather/admin/departments')}
