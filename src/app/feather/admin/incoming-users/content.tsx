...
// "Pending Approval" strip that used to live at the top of /feather/team.
// Three tabs:
    ...
    return (
      <div className="p-8 max-w-xl mx-auto" style={{ fontFamily: 'var(--font-body)' }}>
        <div className="rounded-2xl border border-amber-200 bg-amber-50/60 p-6">
          ...
          <Link href="/feather" className="mt-4 inline-block text-xs font-semibold text-primary hover:underline">Back to app</Link>
        </div>
      </div>
    );
  }
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          >
            ...
            <p className="mt-1 text-[12px] text-foreground/65 leading-snug">
              Mark them as a guest and choose exactly which /feather pages they can view. Anything not on the list is denied.
            </p>
          </button>
          <button
            type="button"
      ...
      <div className="px-6 py-5">
        <div className="flex items-center justify-between mb-3">
          <p className="text-[12px] text-foreground/65">
            Toggle the /feather pages this guest can view. Anything not on the list is hidden + bounces them on direct nav.
          </p>
          <div className="flex items-center gap-2">
