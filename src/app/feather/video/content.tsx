...
export default function VideoContent() {
  ...
  // SEO batch runner — mirrors the SEO Images flow on /feather/images.
  ...
  // ?autoRun=1 (e.g. the "SEO Video" button on /feather/seo) kicks off a
  // gallery pass automatically once the videos list has loaded. Mirrors
  // the same pattern used on /feather/images.
