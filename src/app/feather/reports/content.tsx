...
// ------------------------------------------------------------
// QuickBooks Reports — tabbed view over the read-only side of QBO.
// Budgets live on /feather/finance; this page is pure reporting:
// Company info, Accounts list, P&L / P&L monthly, Balance Sheet,
// Trial Balance, General Ledger.
//
// All reports except Company/Accounts use QBO's generic
// {Header, Columns, Rows} shape, which we flatten into an indented
// table with GenericReport.
// ------------------------------------------------------------
...
export default function ReportsContent() {
  ...
  useEffect(() => {
    ...
    if (!isAdmin) router.replace('/feather');
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-10">
      <QuickBooksHeader
        title="Reports"
        subtitle="Company, accounts, P&L, balance sheet, trial balance, and general ledger — pulled live from QuickBooks."
...
function ReportBody({ tab, data }: { tab: Tab; data: unknown }) {
  ...
  if (tab === 'accounts') {
    ...
    // Sort by account number so the chart of accounts reads in its
    // natural 1000/2000/6000 order. Rows with no AcctNum fall to the
    // bottom and then sort by name.
