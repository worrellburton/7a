  ...
  if (!doc) {
    return (
      <div className="px-4 sm:px-6 lg:px-10 py-10">
        <Link href="/feather/document-manager" className="text-xs text-primary hover:underline" style={{ fontFamily: 'var(--font-body)' }}>
    ...
    <div className="flex flex-col h-full min-h-0">
      <div className="px-4 sm:px-6 lg:px-10 pt-6 pb-4 flex items-start justify-between gap-4 flex-wrap">
        <div className="min-w-0">
          <Link
            href={`/feather/document-manager${doc.category === 'policies' ? '' : `?tab=${doc.category}`}`}
