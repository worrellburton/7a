...
function pageLabelFromPath(path: string | null): string {
  ...
  // Any job-description detail view (e.g. /feather/job-descriptions/<uuid>) should
...
export default function UsersContent() {
  ...
  useEffect(() => {
    ...
    async function fetchUsers() {
      ...
      if (Array.isArray(data)) {
        ...
        // /feather/incoming-users and shouldn't clutter the staff grid.
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-10">
      ...
      {/* Pending Approval moved to /feather/incoming-users (super-admin
                      ...
                      {(() => {
                        ...
                        return (
                          <div className="flex items-center gap-1.5">
                            ...
                            {matchedJd && (
                              <button
                                onClick={() => router.push(`/feather/job-descriptions/${matchedJd.id}`)}
