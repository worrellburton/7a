...
export default function WhatsNewButton() {
  ...
  return (
    <Link
      ...
      className="hidden sm:flex fixed bottom-4 right-4 z-40 group items-center gap-2 px-3 py-2.5 rounded-full bg-white border border-gray-200 shadow-md hover:shadow-lg hover:border-primary/40 transition-all"
