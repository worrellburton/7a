...
export const metadata: Metadata = {
  title: 'Why Us?',
  description:
    'Discover what sets Seven Arrows Recovery apart: boutique setting, small groups, Swisshelm Mountains location, holistic and evidence-based treatment, and our proprietary TraumAddiction approach.',
};
