...
export const metadata: Metadata = {
  ...
  description:
    "Medically supervised detoxification at Seven Arrows Recovery provides 24/7 medical oversight in a comfortable, safe setting to help you through withdrawal and transition into treatment.",
};
