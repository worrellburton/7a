...
// (/hero/resident-reading-window.jpg) before per-article art
...
const LEGACY_PLACEHOLDER = '/hero/resident-reading-window.jpg';

const LEGACY_ROTATION_IMAGES: string[] = [
  '/hero/equine-therapy-portrait.jpg',
  '/hero/horses-grazing.jpg',
  '/hero/horse-sketch-artwork.jpg',
  '/images/campfire-ceremony-circle.webp',
  '/hero/common-area-living-room.jpg',
  '/hero/covered-porch-desert-view.jpg',
  '/hero/embrace-connection.jpg',
  '/hero/facility-exterior-mountains.jpg',
  '/hero/group-gathering-pavilion.jpg',
  '/hero/group-sunset-desert.jpg',
  '/hero/group-therapy-room.jpg',
  '/hero/individual-therapy-session.jpg',
  '/hero/resident-reading-window.jpg',
  '/hero/sign-night-sky-milky-way.jpg',
  '/hero/sound-healing-session.jpg',
];
