...
const defaultPages: PageConfig[] = [
  ...
  { path: '/app/partnerships', label: 'Contacts and Partners', adminOnly: false, section: 'nav', sort_order: 15.4, allowedDepartments: [], departmentId: 'dfde0b96-c605-40dd-84e5-281af2f6d8e9' },
