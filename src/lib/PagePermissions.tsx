...
const defaultPages: PageConfig[] = [
  ...
  { path: '/app/partnerships', label: 'Partnerships', adminOnly: false, section: 'nav', sort_order: 15.4, allowedDepartments: [], departmentId: 'dfde0b96-c605-40dd-84e5-281af2f6d8e9' },
  ...
  // Content — blog pipeline list view. Browse is open to every
  // signed-in user (adminOnly: false) so non-super admins can see the
  // pipeline; the per-post editor (/app/content/[id]) and every
  // /api/content/* write route still enforce requireSuperAdmin so
  // publishing stays locked to super admins.
  { path: '/app/content', label: 'Content', adminOnly: false, section: 'nav', sort_order: 26, allowedDepartments: [], departmentId: null },
